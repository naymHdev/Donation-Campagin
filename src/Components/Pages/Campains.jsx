...
const Campains = ({campains}) => {
  ...
  return (
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-md lg:-mt-96">
          ...
          <div className="flex justify-center items-center">
            ...
            />
            <button onClick={() => handleSearch()} className="btn rounded-tl-none rounded-tr-2xl rounded-br-2xl rounded-bl-none bg-red-600 border-none ">
              Search
            </button>
          </div>
        </div>
    ...
    <div className='grid md:grid-cols-3 lg:grid-cols-4 gap-5 mt-8 mb-8'>
      {
        displayCategory.map( camp => <Campain key={camp.id} camp={camp}></Campain> )
      }
    </div>
    </div>
  );
